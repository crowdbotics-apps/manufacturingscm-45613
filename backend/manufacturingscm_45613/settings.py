"""
Django settings for manufacturingscm_45613 project.
...
ROOT_URLCONF = 'manufacturingscm_45613.urls'
...
WSGI_APPLICATION = 'manufacturingscm_45613.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "manufacturingscm_45613 API",
    "DESCRIPTION": "API documentation for manufacturingscm_45613 App",
    "VERSION": "v1",
}
